import fs from 'fs'
// import TSNE from './dist/modules/tsne/index.js'
...
// model.init({
//     data: data_razors.map(razor => razor.embedding),
//     type:'dense'
// })

// model.run();

// let embeddings_visual = model.getOutputScaled();
...
fs.writeFile('./database.json',JSON.stringify(result),'utf-8',() => {})
